...
const ProductSortOption = {
  ...
  /**
   * Returns a <code>ProductSortOption</code> enum value from a JavaScript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
  * @return {module:model/ProductSortOption} The enum <code>ProductSortOption</code> value.
   */
